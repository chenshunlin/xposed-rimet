...
package tk.anysoft.xposed.gossip.ui.dialog;
...
import tk.anysoft.xposed.gossip.data.M;
import tk.anysoft.xposed.gossip.data.model.LocationModel;
import tk.anysoft.xposed.gossip.data.model.StationModel;
import tk.anysoft.xposed.gossip.data.model.WifiModel;
import tk.anysoft.xposed.gossip.ui.activity.AnalysisActivity;
import tk.anysoft.xposed.gossip.ui.activity.MainActivity;
import tk.anysoft.xposed.gossip.ui.util.ActivityUtil;
import tk.anysoft.xposed.gossip.ui.util.DialogUtil;
import tk.anysoft.xposed.gossip.ui.util.XViewUtil;
...
public class SettingsDialog extends BasePluginDialog {
    ...
    public void createView(PluginFrameLayout frameView) {
        ...
        /*****************   红包   ****************/
        //只有国内版支持红包功能
        if (XConstant.Gossip.PACKAGE_NAME.get(0).equals(getCoreManager().getLoadPackage().getPackageName())){
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (CollectionUtil.isEmpty(map)
                || (XConstant.Gossip.PACKAGE_NAME.get(0).equals(packageName) && map.size() < 3)
                || (XConstant.Gossip.PACKAGE_NAME.get(1).equals(packageName) && map.size() < 2) )
        ...
        if (XConstant.Gossip.PACKAGE_NAME.get(0).equals(packageName)){
