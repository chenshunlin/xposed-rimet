...
public class LocationPlugin extends BasePlugin {
    ...
    public void hook() {
        ...
        Alog.d(this.getClass().getName(),
                XConstant.Gossip.PACKAGE_NAME.get(1) + " : location");
    ...
    /**
     * hook 标准 gps isProviderEnabled 所有定位都会判断GPS开关状态
     */
    ...
    private void hookBasicGPS() {
        ...
        findMethod(
                ...
                "getAllProviders")
                .after(param -> {
                    Alog.d(this.getClass().getName(), String.format("invoke getAllProviders providers=%s", GsonUtil.toJson(param.getResult())));
                    if (isEnable(XConstant.Key.ENABLE_VIRTUAL_LOCATION)) {
//                        param.setResult("gps");//net  //List<String>
                    }
                });
        findMethod(
                LocationManager.class,
                ...
                .before(param -> {
                    Alog.d(this.getClass().getName(), String.format("invoke getBestProvider arg0=%s arg1=%b", GsonUtil.toJson(param.args[0]), param.args[1]));
                    if (isEnable(XConstant.Key.ENABLE_VIRTUAL_LOCATION)) {
                        param.setResult("gps");//String
                    }
                });
        ...
        findMethod(
                ...
                .before(param -> {
                    Alog.d(this.getClass().getName(), String.format("invoke getProviders arg0=%s arg1=%b", GsonUtil.toJson(param.args[0]), param.args[1]));
                    if (isEnable(XConstant.Key.ENABLE_VIRTUAL_LOCATION)) {
                        Alog.e(this.getClass().getName(), "getProviders");//List<String>
                    }
                });

        findMethod(
                LocationManager.class,
                "getProviders", boolean.class)
                .before(param -> {
                    Alog.d(this.getClass().getName(), String.format("invoke getProviders arg0=%b", param.args[0]));
                    if (isEnable(XConstant.Key.ENABLE_VIRTUAL_LOCATION)) {
                        Alog.e(this.getClass().getName(), "getProviders");//List<String>
                    }
                });
        ...
        findMethod(
                ...
                .after(param -> {
                    Alog.d(this.getClass().getName(), String.format("invoke getGpsStatus arg0=%s", GsonUtil.toJson(param.args[0])));
                    Alog.d(this.getClass().getName(), "getGpsStatus");
                    if (isEnable(XConstant.Key.ENABLE_VIRTUAL_LOCATION)) {
        ...
        findMethod(
                ...
                .before(param -> {
                    Alog.d(this.getClass().getName(), String.format("invoke requestLocationUpdates arg0=%s arg1=%d arg2=%f arg3=%s"
                            , param.args[0]
                            , param.args[1]
                            , param.args[2]
                            , GsonUtil.toJson(param.args[3])
                    ));
                    if (isEnable(XConstant.Key.ENABLE_VIRTUAL_LOCATION)) {
        ...
        findMethod(
                ...
                .after(param -> {
                    Alog.d(this.getClass().getName(), String.format("invoke getLastKnownLocation arg0=%s", param.args[0]));
                    if (isEnable(XConstant.Key.ENABLE_VIRTUAL_LOCATION)) {
        ...
        findMethod(
                ...
                "getLastLocation")
                .after(param -> {
                    Alog.d(this.getClass().getName(), String.format("invoke getLastLocation"));
//                        param.setResult(getLastKnownLocation(param.getResult()));
                    Location l = new Location(LocationManager.GPS_PROVIDER);
                    l.setLatitude(22.54245);
                    l.setLongitude(113.949098);
    ...
    private void setGpsStatus(GpsStatus gss) {
        ...
        try {
            ...
            Alog.d(this.getClass().getName(), e.getLocalizedMessage());
        }
    }
    ...
    private Object getLastKnownLocation(Object location) {
        Alog.d(this.getClass().getName(), String.format("invoke getLastKnownLocation"));
    ...
    private final class AMapLocationListenerProxy implements InvocationHandler {
        ...
        public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
            ...
            } else if (isEnableVirtualLocation()
                    && "onStatusUpdate".equals(method.getName())) {
