...
package tk.anysoft.xposed.gossip.data.cache;
 ...
 */
public class GossipCache implements IGossipCache {

    private static final long TIMEOUT = 1000 * 60 * 60;

    private ICacheManager mCacheManager;

    public GossipCache(ICacheManager iCacheManager) {
...
//        return model != null && !isExpired(lastTime) ? model : null;
    ...
    private boolean isExpired(long lastTime) {
        ...
        return curTime - lastTime >= GossipCache.TIMEOUT || curTime < lastTime;
    }
}
