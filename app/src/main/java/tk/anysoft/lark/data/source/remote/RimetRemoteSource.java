...
package tk.anysoft.lark.data.source.remote;

import tk.anysoft.lark.data.cache.IRimetCache;
import tk.anysoft.lark.data.model.ConfigModel;
import tk.anysoft.lark.data.model.UpdateModel;
import tk.anysoft.lark.data.model.VersionModel;
import tk.anysoft.lark.data.service.IRimetService;
import tk.anysoft.lark.data.service.IServiceFactory;
import tk.anysoft.lark.data.source.IRimetSource;
