...
package tk.anysoft.lark.ui.dialog;
...
import tk.anysoft.lark.data.M;
import tk.anysoft.lark.data.model.LocationModel;
import tk.anysoft.lark.data.model.StationModel;
import tk.anysoft.lark.data.model.WifiModel;
import tk.anysoft.lark.ui.activity.MainActivity;
import tk.anysoft.lark.ui.util.ActivityUtil;
import tk.anysoft.lark.ui.util.DialogUtil;
import tk.anysoft.lark.ui.util.XViewUtil;
import tk.anysoft.lark.util.FileUtil;
import tk.anysoft.lark.util.GsonUtil;
...
//        /*****************   红包   ****************/
//        //只有国内版支持红包功能
//        if (!XConstant.apps.PACKAGE_NAME.get(1).equals(getCoreManager().getLoadPackage().getPackageName())) {
...
//
//        setPromptText(TextUtils.equals(cMd5, aMd5) ? "" : getString(R.string.dialog_notice_not_support));
    }
    ...
    public void onCreateMoreMenu(Menu menu) {
        ...
        menu.add(0, 0, 0, R.string.menu_love_and_charity);
        menu.add(0, 1, 0, R.string.menu_helper);
        menu.add(0, 2, 0, R.string.menu_support);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (CollectionUtil.isEmpty(map)
                || (!XConstant.apps.PACKAGE_NAME.get(1).equals(packageName) && map.size() < 3)
                || (XConstant.apps.PACKAGE_NAME.get(1).equals(packageName) && map.size() < 2))
        ...
        if (!XConstant.apps.PACKAGE_NAME.get(1).equals(packageName)) {
