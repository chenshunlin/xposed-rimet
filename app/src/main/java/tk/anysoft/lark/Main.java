...
import tk.anysoft.lark.plugin.LuckyPlugin;
...
public class Main implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpParam) throws Throwable {
        ...
        if (!XConstant.apps.PACKAGE_NAME.contains(lpParam.packageName)) return;
        Log.d("aaaaaaaaaaa",lpParam.packageName);
        ...
        try {
            XposedUtil.findMethod(
                    "com.ss.android.lark.app.LarkApplication", "onCreate")
        ...
        XCoreManager coreManager = new CoreManager.Build(context)
                ...
                .setComponentFactory(new ComponentFactory() {
                    ...
                    protected List<Class<? extends XPlugin>> getPluginData() {
                        ...
                        if (XConstant.apps.PACKAGE_NAME.get(1).equals(lpParam.packageName)) {
