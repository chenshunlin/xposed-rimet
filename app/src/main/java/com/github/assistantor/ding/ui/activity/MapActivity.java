...
import com.github.assistantor.ding.ui.util.MapUtil;
import com.sky.xposed.common.util.Alog;
import com.sky.xposed.common.util.CollectionUtil;
import com.sky.xposed.common.util.ToastUtil;
import com.github.assistantor.ding.R;
import com.github.assistantor.ding.ui.adapter.SearchResultAdapter;
...
public class MapActivity extends Activity implements LocationSource, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            Alog.e(this.getClass().getName(), e.getMessage());
        }
